...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('http://cdns.annnibb.me/cf79ae6addba60ad018347359bd144d2.json') || [];
...
function getAuthorShareCode(url = "https://cdns.jsdelivr.net/gh/gitupdate/updateTeam@master/shareCodes/jxhb.json") {
  return new Promise(resolve => {
    const options = {
